...
![Активных](https://img.shields.io/endpoint?url=https://stats.xpepelok.me/metrics&labelColor=64748b)
...
- **Импорт по логину/паролю** — вставляешь список аккаунтов, приложение само вводит их в лаунчер и сохраняет токены. Дубли и уже сохранённые пропускаются, прогресс идёт в фоне.
